...
/**
 * Provides the local service interface for MacroscopeDocument. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author dave
 * @see MacroscopeDocumentLocalServiceUtil
...
public interface MacroscopeDocumentLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MacroscopeDocumentLocalServiceUtil} to access the macroscope document local service. Add custom service methods to {@link edu.ucla.macroscope.textlibrary.service.impl.MacroscopeDocumentLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
